...
#define FUCKING_LSEEK_OFFSET 1024
  ...
  Log("TEST: /data/therapist, 512 buffer, 0 offset");
  DumpDirents(fd, 512, 0);
  Log("TEST: /data/therapist, 512 buffer, 5 offset");
  DumpDirents(fd, 512, 5);
  //   Log("TEST: /data/therapist, 550 buffer, 0 offset");
  //   DumpDirents(fd, 550, 0);
  //   Log("TEST: /data/therapist, 550 buffer, 5 offset");
  //   DumpDirents(fd, 550, 5);
  Log("TEST: /data/therapist, 768 buffer, 0 offset");
  DumpDirents(fd, 768, 0);
  Log("TEST: /data/therapist, 768 buffer, 5 offset");
  DumpDirents(fd, 768, 5);
  //   Log("TEST: /data/therapist, 1024 buffer, 0 offset");
  //   DumpDirents(fd, 1024, 0);
  //   Log("TEST: /data/therapist, 1024 buffer, 5 offset");
